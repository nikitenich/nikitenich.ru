...
<input type=button class="buttonteg" value="spoil" title="Добавялет спойлер." onclick="__addTag(\'<details>\',\'</details>\', \''+getareaid+'\')"> \
...
<input type=button class="buttonteg" value="quote" title="Создает выделеную цитату чужого сообщения (работает только в обсуждениях)" style="width:40px;" onclick="'+quote+'"> \
<br />\
<input type=button class="buttonteg" value="left" title="Располагает текст по левому краю." onclick="__addTag(\'<p align=&quot;left&quot;>\',\'</p>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="center" title="Располагает текст по центру." onclick="__addTag(\'<p align=&quot;center&quot;>\',\'</p>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="right" title="Располагает текст по правому краю." onclick="__addTag(\'<p align=&quot;right&quot;>\',\'</p>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="justify" title="Выравнивает текст по ширине." onclick="__addTag(\'<p align=&quot;justify&quot;>\',\'</p>\', \''+getareaid+'\')"> \
<br />\
