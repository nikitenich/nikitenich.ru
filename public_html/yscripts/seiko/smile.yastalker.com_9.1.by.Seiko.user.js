// ==UserScript==
// @name           smile.yastalker.com_9.1.by.Seko.user
// @namespace      *
// @include        *yastalker*
// ==/UserScript==
...
<tbody style="background:#000000 url(http://savepic.net/2806216.jpg);">\
...
<input type=button class="buttonteg" value="Strike" title="Устанавливает тег, зачеркнутый текст вариант №2" onclick="__addTag(\'<strike>\',\'</strike>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="P" title="Устанавливает тег, абзац текста" onclick="__addTag(\'<p>\',\'</p>\', \''+getareaid+'\')"> \
...
<input type=button class="buttonteg" value="Выравнивание-центр" title="Вставляет тег,выравнивающий текст по центру" onclick="__addTag(\'<p style=&quot;text-align: center;;&quot;>\',\'</p>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="Выравнивание-право" title="Вставляет тег,выравнивающий текст по правому краю" onclick="__addTag(\'<p style=&quot;text-align: right;;&quot;>\',\'</p>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="Выравнивание-лево" title="Вставляет тег,выравнивающий текст по левому краю" onclick="__addTag(\'<p style=&quot;text-align: left;;&quot;>\',\'</p>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="Увеличение отступа-лево" title="Вставляет тег,увеличевающий отступ от левого края " onclick="__addTag(\'<p style=&quot;margin-left: 40px;;&quot;>\',\'</p>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="Ширина" title="Вставляет тег,написания текста по ширине " onclick="__addTag(\'<p style=&quot;text-align: justify;;&quot;>\',\'</p>\', \''+getareaid+'\')"> \
     </div>\
</td> \
</tr></div> '
		}
