// ==UserScript==
// @name           htmltagbuttons_v7_by_Dismal
// @namespace      *
// @include        *yastalker*
// ==/UserScript==
...
// modification by Sergey "Dismal" Sobyanin
...
.buttonteg_smileTable, .buttonteg_faceTable, .buttonteg_stalkeTable {\
width:92px;\
...
.smilesRow a, .facesRow a, .stalkerRow a  {\
padding:0px;\
text-align:center;\
}\
#buttonteg_smilesRow, #buttonteg_facestwoRow, #buttonteg_facesoneRow, #buttonteg_facesthreeRow, #buttonteg_facesfourRow, #buttonteg_facesfiveRow, #buttonteg_facessixRow, #buttonteg_facesRow, #buttonteg_animsRow, #buttonteg_stalkerRow {\
display:none;\
}\
.close {\
float:right;\
...
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_smilesRow\',\'block\');" class="close">[X]</a>Смайлы</th></tr>\
<tbody style="background:#222222;">\
<tr>\
...
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://i.smiles2k.net/aiwan_smiles/taunt.gif&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://i.smiles2k.net/aiwan_smiles/taunt.gif" border="0" /></a></td>\
...
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://i.smiles2k.net/aiwan_smiles/umnik2.gif&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://i.smiles2k.net/aiwan_smiles/umnik2.gif" border="0" /></a></td>\
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://i.smiles2k.net/aiwan_smiles/tommy.gif&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://i.smiles2k.net/aiwan_smiles/tommy.gif" border="0" /></a></td>\
...
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://www.mysmiles.ru/offtopic.gif&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://www.mysmiles.ru/offtopic.gif" border="0" /></a></td>\
			...
			anims = '<div id="buttonteg_animsRow"><table class="buttonteg_faceTable">\
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_animsRow\',\'block\');" class="close">[X]</a>Аниме</th></tr>\
<tbody style="background:#222222;">\
<tr>\
...
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://smayly.ru/gallery/anime/EmoAnime/158.gif&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://smayly.ru/gallery/anime/EmoAnime/158.gif" border="0" /></a></td>\
			...
			facesone = '<div id="buttonteg_facesoneRow"><table class="buttonteg_faceTable">\
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_facesoneRow\',\'block\');" class="close">[X]</a>Нинель-фэйсы</th></tr>\
<tbody style="background:#222222;">\
...
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://savepic.net/2355561.png&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://savepic.net/2355561.png" border="0" height=50 /></a></td>\
			...
			faces = '<div id="buttonteg_facesRow"><table class="buttonteg_facesTable">\
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_facesRow\',\'block\');" class="close">[X]</a>Фэйсы</th></tr>\
<tbody style="background:#222222;">\
...
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://savepic.su/1526599m.png&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://savepic.su/1526599m.png" border="0" /></a></td>\
			...
			facestwo = '<div id="buttonteg_facestwoRow"><table class="buttonteg_faceTable">\
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_facestwoRow\',\'block\');" class="close">[X]</a>Фэйсы 2.0</th></tr>\
<tbody style="background:#222222;">\
<tr><td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://savepic.su/1090764m.png&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://savepic.su/1090764m.png" border="0" /></a></td>\
...
<td></td>\
			...
			facesfour = '<div id="buttonteg_facesfourRow"><table class="buttonteg_faceTable">\
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_facesfourRow\',\'block\');" class="close">[X]</a>Netural</th></tr>\
<tbody style="background:#222222;">\
<tr>\
...
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_stalkerRow\',\'block\');" class="close">[X]</a>Смайлы для девушек</th></tr>\
<tbody style="background:#222222;">\
...
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://www.kolobok.us/smiles/he_and_she/girl_wink.gif&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://www.kolobok.us/smiles/he_and_she/girl_wink.gif" border="0" /></a></td>\
			...
			facesthree = '<div id="buttonteg_facesthreeRow"><table class="buttonteg_faceTable">\
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_facesthreeRow\',\'block\');" class="close">[X]</a>FFFUUU</th></tr>\
<tbody style="background:#222222;">\
<tr>\
...
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://savepic.su/1538849m.png&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://savepic.su/1538849m.png" border="0" /></a></td>\
			...
			facesfive = '<div id="buttonteg_facesfiveRow"><table class="buttonteg_faceTable">\
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_facesfiveRow\',\'block\');" class="close">[X]</a>Яо Минг</th></tr>\
<tbody style="background:#222222;">\
...
<td class="smilesRow"><a href="javascript:__addSmile(\'<img src=&quot;http://savepic.net/2413132m.png&quot; border=&quot;0&quot; />\',\''+getareaid+'\');"><img src="http://savepic.net/2413132m.png" border="0" /></a></td>\
			...
			facessix = '<div id="buttonteg_facessixRow"><table class="buttonteg_faceTable">\
<tr><th colspan="12" style="text-align:center;"><a href="javascript:switchLayer(\'buttonteg_facessixRow\',\'block\');" class="close">[X]</a>Others faces</th></tr>\
<tbody style="background:#222222;">\
...
tagbuttons = smiles+faces+anims+facesone+facestwo+facesthree+facesfour+facesfive+facessix+stalker+'<div style="margin-top:5px;"><tr> \
...
<input type=button class="buttonteg" value="quote" title="Цитирование (работает только в темах)." onclick="__addTag(\'[quote=name]\',\'[/quote]\', \''+getareaid+'\')"> \
...
<br />\
<input type=button class="buttonteg" value="style" title="Устанавливает стиль элемента" onclick="__addTag(\'<a style=&quot;&quot;>\',\'</a>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="color" title="Вставляет тег, изменяющий цвет выделенного текста" onclick="__addTag(\'<a style=&quot;color:;&quot;>\',\'</a>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="font" title="Вставляет тег, изменяющий тип шрифта" onclick="__addTag(\'<a style=&quot;font-size:;&quot;>\',\'</a>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="size" title="Вставляет тег, изменяющий размер текста" onclick="__addTag(\'<a style=&quot;font-size:;&quot;>\',\'</a>\', \''+getareaid+'\')"> \
<input type=button class="buttonteg" value="font+size" title="Вставляет тег, изменяющий тип шрифта и размер текста" onclick="__addTag(\'<a style=&quot;font-family:; font-size:;&quot;>\',\'</a>\',\''+getareaid+'\')"> \
     </div>\
</td> \
<hr id="hr_smiles" /> \
...
<input type=button class="buttonteg" value="Фейсы" title="Открывает внутри страницы окно с выбором Фейсов" id="s_link" onclick="switchLayer(\'buttonteg_facesRow\',\'block\');"> \
<input type=button class="buttonteg" value="Аниме" title="Открывает внутри страницы окно с выбором аниме" id="s_link" onclick="switchLayer(\'buttonteg_animsRow\',\'block\');"> \
</tr></div>\
<div id="more_faces_show" style="display:inline;font-size:10px;"><a href="javascript:switchLayer(\'more_faces\',\'inline\')" onclick="javascript:switchLayer(\'more_faces_show\',\'inline\')" title="Фэйсы, фэйсы, больще фэйсов...">Еще фейсы...</a></div>\
	<div id="more_faces" style="display:none;">\
	<input type=button class="buttonteg" value="Фейсы 2.0" title="Открывает внутри страницы окно с выбором фейсов" id="s_link" onclick="switchLayer(\'buttonteg_facestwoRow\',\'block\');"> \
	<input type=button class="buttonteg" value="Нинель-Фейсы" title="Открывает внутри страницы окно с выбором нинель-фейсов" id="s_link" onclick="switchLayer(\'buttonteg_facesoneRow\',\'block\');"> \
	<input type=button class="buttonteg" value="Netural" title="Открывает внутри страницы окно с выбором фейсов" id="s_link" onclick="switchLayer(\'buttonteg_facesfourRow\',\'block\');"> \
	<input type=button class="buttonteg" value="FFFUUU" title="FFFUUU" id="s_link" onclick="switchLayer(\'buttonteg_facesthreeRow\',\'block\');"> \
	<input type=button class="buttonteg" value="Яо Минг" title="Открывает внутри страницы окно с выбором фейсов" id="s_link" onclick="switchLayer(\'buttonteg_facesfiveRow\',\'block\');"> \
	<input type=button class="buttonteg" value="Others" title="Открывает внутри страницы окно с выбором фейсов" id="s_link" onclick="switchLayer(\'buttonteg_facessixRow\',\'block\');"> \
	</div>'
		}
	}
